// ArthSetu — Static localization string maps for EN / HI / MR
...
const AppStrings _en = AppStrings(
  ...
  rateBasedOnScore: 'Rate is based on your credit score. Final rate confirmed on submission.',
  kycRequiredTitle: 'KYC Verification Required',
  kycRequiredBody: 'You must complete KYC verification before creating a loan request.',
  ...
  reducingBalanceNote: 'Reducing balance method: each EMI pays decreasing interest and increasing principal.',
...
const AppStrings _hi = AppStrings(
  ...
  repayLoan: 'ऋण चुकाएं',
  loanRequestCreated: 'ऋण अनुरोध बनाया गया! दर और EMI सर्वर द्वारा पुष्टि की गई।',
  ...
  rateBasedOnScore: 'दर आपके क्रेडिट स्कोर पर आधारित है। जमा करने पर अंतिम दर की पुष्टि।',
  ...
  reducingBalanceNote: 'घटता बैलेंस विधि: प्रत्येक EMI घटते ब्याज और बढ़ते मूलधन का भुगतान करती है।',
...
const AppStrings _mr = AppStrings(
  ...
  loanRequestCreated: 'कर्ज विनंती तयार झाली! दर आणि EMI सर्व्हरने पुष्टी केली.',
  ...
  rateBasedOnScore: 'दर तुमच्या क्रेडिट स्कोरवर आधारित आहे. सादरीकरणावर अंतिम दर पुष्टी.',
  kycRequiredTitle: 'KYC सत्यापन आवश्यक',
  kycRequiredBody: 'कर्ज विनंती करण्यापूर्वी KYC सत्यापन पूर्ण करणे आवश्यक आहे.',
  ...
  reducingBalanceNote: 'घटणारी शिल्लक पद्धत: प्रत्येक EMI कमी व्याज आणि जास्त मुद्दल भरते.',
